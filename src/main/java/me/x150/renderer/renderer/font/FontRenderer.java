...
public class FontRenderer {
     ...
     */
    public static FontRenderer create(Font font, float sizePx) {
        return new FontRenderer(font, sizePx);
    }
    ...
    public void drawString(MatrixStack matrices, String s, float x, float y, me.x150.renderer.renderer.Color color) {
    ...
    public void drawCenteredString(MatrixStack matrices, String s, float x, float y, me.x150.renderer.renderer.Color color) {
