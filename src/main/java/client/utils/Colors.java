...
public class Colors implements MCUtil {
    ...
    public static int getTeamColor(PlayerEntity entityIn) {
        int i = -1;
            if (entityIn.getDisplayName().getString().equalsIgnoreCase("§f[§cR§f]§c" + entityIn.getName())) {
                i = Colors.getColor(new Color(255, 60, 60));
            } else if (entityIn.getDisplayName().getString().equalsIgnoreCase("§f[§9B§f]§9" + entityIn.getName())) {
                i = Colors.getColor(new Color(60, 60, 255));
            } else if (entityIn.getDisplayName().getString().equalsIgnoreCase("§f[§eY§f]§e" + entityIn.getName())) {
                i = Colors.getColor(new Color(255, 255, 60));
            } else if (entityIn.getDisplayName().getString().equalsIgnoreCase("§f[§aG§f]§a" + entityIn.getName())) {
